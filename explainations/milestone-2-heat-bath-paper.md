...
> **Tabella riverificata** dopo il consolidamento delle sorgenti in un solo
> giro sulle celle (vedi `milestone-1-VT-relaxation.md` §2.1): nessuno di
> questi numeri si muove.
