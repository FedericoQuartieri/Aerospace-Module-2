...
OpenFOAM-13 + Mutation++ in un container Linux, con il progetto montato da
macOS.

Su Apple Silicon l'immagine è **arm64 nativa**: `dl.openfoam.org` pubblica
`openfoam13` anche per arm64, quindi niente emulazione QEMU, e i tempi di
calcolo sono quelli veri della macchina.
