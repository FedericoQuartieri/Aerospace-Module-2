...
(Sezione~\ref{sec:programmi0D} e i casi \shockThermo{} corrispondenti della
Sezione~\ref{sec:implementato-costo}).
...
\subsubsection{Costo di calcolo}
...
Oltre questo punto il margine residuo è limitato da una ragione strutturale:
una volta consolidata la valutazione delle sorgenti, più della metà del tempo
è OpenFOAM — solutori lineari, ricostruzione dei flussi, scrittura dei campi —
e cresce con il numero di celle esattamente come la parte termochimica, così
che infittire la griglia non cambia il rapporto.
