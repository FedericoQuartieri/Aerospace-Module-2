...
un secondo contro quasi mezz'ora. La differenza è sovrastruttura, non fisica:
anche con una sola cella il solver costruisce e risolve una matrice per ogni
...
con l'articolo entro lo 0{,}3\%. Si sono quindi seguiti i risultati: il progetto ha due versioni dei
