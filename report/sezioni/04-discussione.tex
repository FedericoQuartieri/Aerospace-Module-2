...
del lavoro di riferimento entro circa 50~K, cioè entro l'incertezza con cui si
leggono le figure; nei casi con reazioni le temperature a fine calcolo
differiscono al più di 100~K, la composizione della miscela di azoto coincide
entro il 2{,}5\% e quella dell'aria entro 0{,}06 decadi. Nel transitorio l'accordo
...
vibrazionale, un fattore 3 sulle densità dell'aria e oltre 6000~K sulla
temperatura finale. Lo stesso articolo ne dà un esempio quando spiega la
differenza con LeMANS nella fig.~5 con una diversa convenzione nella
correzione di Park.
